...
read_excel('D:/R_wd/week1/R_class/R_class/Data/reef_fish.xlsx') # automatically print on my screen
fish<-read_excel('D:/R_wd/week1/R_class/R_class/Data/reef_fish.xlsx') # store my table in an object called `fish`
fish # print my object `fish`   

# importing a .txt file
fish<-read.table('D:/R_wd/week1/R_class/R_class/Data/reef_fish.txt', header=T, sep='\t', dec='.') 
